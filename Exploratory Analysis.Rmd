...
bikes= read.csv("C:/Users/Smit Ajmera/Desktop/IS665/classwork/nyc.csv")
bikes
```
...
hist(Trip_Duration_in_min, data=bikes2)
...
require(lattice)
require(ggplot2)
my.breaks= seq(2015,2016,2017)
hist(bikes$Start.Time,breaks=my.breaks)
##So we can observe that the highest useage of cycles was in the year 2016.
```
...
```
```{r}
# This report helps to understand the dataset 
```
